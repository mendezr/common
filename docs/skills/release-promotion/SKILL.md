...
| [references/printer-app-promotion.md](references/printer-app-promotion.md) | Printer-application `testing`→`stable` promotion: mechanism, end-to-end proof for all four apps, verified tag publication, branch-protection finding, and PS security hold. |
